...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonControllerAfter : MonoBehaviour
    {
        ...
        private CombatStats playerCombatStats;
        ...
        private void Start()
        {
            ...
            weaponAnim = weapon.WeaponAnimations;
            ...
            //playerCombatStats = GetComponent<CombatStats>(); **all handled by WeaponStats attached to weapon object
            //playerCombatStats.DamageValue = 20;
        }
        ...
        private void Update()
        {
            if (Healthbar.value <= 0)
            {
                ...
                Debug.Log("Player died -- do something here");
                return;
            }
            RotateView();
